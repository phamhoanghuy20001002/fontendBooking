...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = () => {
        ...
        this.props.saveDetailDoctors({
            ...
            actions: hadOldData === true ? CRUD_ACTIONS.EDIT : CRUD_ACTIONS.CREATE,
    ...
    handleChange = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.markdown) {
            let markdowns = res.data.markdown;
            let addressClinic = '';
            let nameClinic = '', note = '', paymentId = '', priceId = '', provinceId = '', specialtyId = '',
    ...
    handleChangeSelectDoctorInfor = async (selectedOption, name) => {
        ...
        console.log('hec check:', stateCopy)
        this.setState({
            ...stateCopy
        })
    }
    ...
    render() {
        let { hadOldData, listSpecialty } = this.state;
        console.log('checkcehce:', this.state);
        console.log('rporp:', this.props)
            ...
            <div className='manage-doctor-container'>
                ...
                <div>
                    <button
                        ...
                        {hadOldData === true ? <span>Update</span> : <span>Create</span>}
                    </button>
                </div>
            </div>
        );
